...
class TestTagAttributes:
    ...
    def test_update_tag_attributes_without_etag(self, management_client):
        did = "some-device-id"
        tags = {
    ...
    def test_replace_tag_attributes_without_etag(self, management_client):
        did = "some-device-id"
    ...
    def test_update_tag_attributes_with_etag(
        ...
        res = management_client.getDevice(did)
        etag_one = res['tags_etag']
        management_client.updateTagAttributes(did, tags_body, eTag=etag_one)

        res = management_client.getDevice(did)
        etag_two = res['tags_etag']
